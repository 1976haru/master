...
def inspect_tail(
    ...
    *,
    ...
    if audio.shape[0] == 0:
        return TailMetrics(float("-inf"), float("-inf"), False)
    ...
    return TailMetrics(end_rms_dbfs, last_sample_dbfs, hard_cut)
...
def apply_click_safe_fade(
    ...
    *,
    ...
    # Equal-power style is unnecessary for a tiny safety fade; linear is predictable and click-safe.
