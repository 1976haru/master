...
def main() -> int:
    ...
    assert run.find("Suno15_Mastering_v3_8.pyw") < run.find("Suno15_Mastering_v3_7_2.pyw")
    ...
    print("[PASS] v3.8 launch paths point away from legacy UI")
    print("Root RUN: v3.8 first")
