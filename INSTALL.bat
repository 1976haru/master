...
echo ============================================================
echo HARU / SUNO 15SET MASTERING v3.7 - MULTI GENRE INSTALL
echo ============================================================
echo.
...
echo [2/13] Updating pip...
".venv\Scripts\python.exe" -m pip install --upgrade pip
if errorlevel 1 goto :FAIL

echo [3/13] Installing FFmpeg helper and audio analysis libraries...
".venv\Scripts\python.exe" -m pip install --upgrade imageio-ffmpeg numpy scipy soundfile pyloudnorm
if errorlevel 1 goto :FAIL

echo [4/13] Installing HARU Mastering v3.7 core from this folder...
".venv\Scripts\python.exe" -m pip install -e .
if errorlevel 1 goto :FAIL

echo [5/13] Verifying v3 feature core...
".venv\Scripts\python.exe" .\scripts\verify_v3_features.py
if errorlevel 1 goto :FAIL

echo [6/13] Verifying v3 runtime adapter...
".venv\Scripts\python.exe" .\scripts\verify_v3_app.py
if errorlevel 1 goto :FAIL

echo [7/13] Verifying v3.2 auto-finish adapter...
".venv\Scripts\python.exe" .\scripts\verify_v31_app.py
if errorlevel 1 goto :FAIL

echo [8/13] Verifying v3.3 codec auto-gain adapter...
".venv\Scripts\python.exe" .\scripts\verify_v33_app.py
if errorlevel 1 goto :FAIL

echo [9/13] Verifying v3.4 smart delay adapter...
".venv\Scripts\python.exe" .\scripts\verify_v34_app.py
if errorlevel 1 goto :FAIL

echo [10/13] Verifying v3.5 adaptive tail adapter...
".venv\Scripts\python.exe" .\scripts\verify_v35_app.py
if errorlevel 1 goto :FAIL

echo [11/13] Verifying v3.6 final report synchronization...
".venv\Scripts\python.exe" .\scripts\verify_v36_app.py
if errorlevel 1 goto :FAIL

echo [12/13] Verifying v3.6.1 final metrics and Tail INFO guard...
".venv\Scripts\python.exe" .\scripts\verify_v361_app.py
if errorlevel 1 goto :FAIL

echo [13/13] Verifying v3.7 expanded genre profiles...
...
echo HARU Mastering v3.7 MULTI GENRE engine is ready.
