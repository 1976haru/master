...
def test_run_bat_prefers_v38_before_v372():
    text = (ROOT / "RUN.bat").read_text(encoding="utf-8", errors="ignore")
    assert text.find("Suno15_Mastering_v3_8.pyw") < text.find("Suno15_Mastering_v3_7_2.pyw")
...
def test_legacy_direct_execution_is_guarded():
    ...
    assert "Suno15_Mastering_v3_8.pyw" in text
